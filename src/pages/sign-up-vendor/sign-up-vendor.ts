...
@IonicPage()
@Component({
  selector: 'page-sign-up-vendor',
  templateUrl: 'sign-up-vendor.html',
})
export class SignUpVendorPage implements OnInit {
  signUpForm: any;
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,
    ...
    this.signUpForm = formBuilder.group({
        ...
        vendorName: ['', Validators.compose([Validators.maxLength(64), Validators.pattern(nameRe), Validators.required])],
        isFoundation: [false]
    });
